...
const translations: BaseMessage = {
	...
	'stats.totalFolders': '文件夹总数',
	'stats.lastActiveFile': '最后活跃文件',
	...
	'settings.resetAllSettings.confirm': '确定要重置所有设置吗？此操作无法撤销。',
	...
	'timeline.edit': '编辑',
	'timeline.view': '查看',
	'timeline.viewAll': '查看全部 {{count}} 个会话',

	// Analysis
	'analysis.sessionPatterns': '会话模式',
	'analysis.fileActivity': '文件活动',
	'analysis.folderActivity': '文件夹活动',
	'analysis.timeDistribution': '时间分布',
	'analysis.totalSessions': '总会话数',
	'analysis.avgSessionTime': '平均会话时长',
	'analysis.longestSession': '最长会话',
	'analysis.shortestSession': '最短会话',
