...
const translations: BaseMessage = {
	...
	'plugin.description': 'Track time spent in Obsidian with detailed statistics',
	...
	'stats.lastActiveFile': 'Last active file',
	...
	'settings.idleThreshold.desc': 'Time in seconds before considering user idle',
	...
	'settings.enableFolderTracking.desc': 'Track time spent in different folders',
	...
	'settings.defaultChartType.desc': 'Default visualization type for statistics',
	...
	'settings.cleanupOldData.desc': 'Remove data older than the retention period',
	...
	'auth.loginDescription': 'Connect to Obtime service to sync your usage data',
	...
	'auth.insufficientPermissions': 'Insufficient permissions for this operation',
	...
	'timeline.edit': 'Edit',
	'timeline.view': 'View',
	'timeline.viewAll': 'View all {{count}} sessions',

	// Analysis
	'analysis.sessionPatterns': 'Session Patterns',
	'analysis.fileActivity': 'File Activity',
	'analysis.folderActivity': 'Folder Activity',
	'analysis.timeDistribution': 'Time Distribution',
	'analysis.totalSessions': 'Total Sessions',
	'analysis.avgSessionTime': 'Average Session',
	'analysis.longestSession': 'Longest Session',
	'analysis.shortestSession': 'Shortest Session',
